...
const ColTitle = ({ children }) => (
  <h3 className="font-sans text-white font-bold text-sm uppercase tracking-widest mb-4 pb-2 border-b border-white/10">
    {children}
  </h3>
);
...
const FLink = ({ onClick, children }) => (
  <li
    onClick={onClick}
    className="font-sans text-white/80 text-[15px] hover:text-white hover:translate-x-1 transition-all duration-200 cursor-pointer leading-relaxed"
  >
    {children}
  </li>
);
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  <span className="font-sans text-white text-[11px] font-bold uppercase tracking-wider block mb-1">Pune</span>
                ...
                <div>
                  <span className="font-sans text-white text-[11px] font-bold uppercase tracking-wider block mb-1">Other Cities</span>
                  <ul className="space-y-1.5">
                    {otherBranches.map((b) => (
                      <FLink key={b.title} onClick={() => navigate(b.path)}>
                        {b.title}
                ...
                <div>
                  <span className="font-sans text-white text-[11px] font-bold uppercase tracking-wider block mb-1">International</span>
                  <ul className="space-y-1.5">
            ...
            <div>
              ...
              <div className="space-y-3 mb-5">
                <a href="tel:+919545450788" className="flex items-center gap-2 text-white/80 hover:text-white transition text-sm">
                  <FaPhoneAlt size={13} className="text-white/60 shrink-0" />
                  +91 9545450788
                </a>
                <a href="tel:+919545450677" className="flex items-center gap-2 text-white/80 hover:text-white transition text-sm">
                  <FaPhoneAlt size={13} className="text-white/60 shrink-0" />
                  +91 9545450677
                </a>
                <a href="mailto:hr@nexusctc.com" className="flex items-center gap-2 text-white/80 hover:text-white transition text-sm">
                  <IoIosMail size={16} className="text-white/60 shrink-0" />
                  hr@nexusctc.com
                </a>
                <a href="mailto:info@nexusctc.com" className="flex items-center gap-2 text-white/80 hover:text-white transition text-sm">
                  <IoIosMail size={16} className="text-white/60 shrink-0" />
                  info@nexusctc.com
                </a>
              </div>
                ...
                {socialMedia.map((item, i) => {
                  ...
                  return (
                    <a
                      ...
                      className="w-10 h-10 rounded-lg bg-white/5 border border-white/8 flex items-center justify-center text-white/60 hover:text-white hover:border-white/40 hover:bg-white/10 transition-all duration-200"
                    >
                      <Icon size={20} />
                    </a>
                  );
