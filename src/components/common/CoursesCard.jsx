...
// ── All course images
import img_ai            from "../../assets/courses/ai.avif";
import img_angular       from "../../assets/courses/angular.avif";
import img_angular1      from "../../assets/courses/angular1.avif";
import img_aws           from "../../assets/courses/aws.avif";
import img_azure         from "../../assets/courses/azure.avif";
import img_bizanalyst    from "../../assets/courses/business_analyst.avif";
import img_csharp        from "../../assets/courses/Csharp_and_dotnet.avif";
import img_cloud         from "../../assets/courses/cloudcomputing.avif";
import img_dataanalytics from "../../assets/courses/dataanalytics.avif";
import img_datascience   from "../../assets/courses/datascience.avif";
import img_datascimath   from "../../assets/courses/datasciencemathematical.avif";
import img_devopscloud   from "../../assets/courses/devopscloud.avif";
import img_core_engine   from "../../assets/courses/Core_engine.avif";
import img_fullstack_dev from "../../assets/courses/Full_stack_developer.avif";
import img_fullstack_net from "../../assets/courses/full_stack_.net_developer.avif";
import img_java          from "../../assets/courses/java.avif";
import img_mern          from "../../assets/courses/Mern_stack_developer.avif";
import img_3d_anim       from "../../assets/courses/3d_animation.avif";
import img_auto_test     from "../../assets/courses/Auto_testing.avif";
import img_db_test       from "../../assets/courses/database_testing.avif";
import img_med_coding    from "../../assets/courses/Medical_coding.avif";
import img_mob_test      from "../../assets/courses/Mobile_testing.avif";
import img_networking    from "../../assets/courses/Netwoking.avif";
import img_osi_soft      from "../../assets/courses/OSI_soft.avif";
import img_powerbi       from "../../assets/courses/powerbisql.avif";
import img_python        from "../../assets/courses/python.avif";
import img_react         from "../../assets/courses/React.avif";
import img_salesforce    from "../../assets/courses/sales_force.avif";
import img_scrum         from "../../assets/courses/Scrum_master.avif";
import img_selenium      from "../../assets/courses/selenium.avif";
import img_softskill     from "../../assets/courses/soft_skill.avif";
import img_sys_test      from "../../assets/courses/system_testing.avif";
import img_tableau       from "../../assets/courses/tableausql.avif";
import img_tosca         from "../../assets/courses/tosca.avif";
import img_web_test      from "../../assets/courses/Web_tesing.avif";
