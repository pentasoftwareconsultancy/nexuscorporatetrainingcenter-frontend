...
const CoursesPage = () => {
  ...
  const filteredCategories = categories
    .map((category) => {
      ...
      // 2. Filter courses by search query (title or description)
      ...
      // If category has no matching courses, hide the section
  ...
  return (
    <section className="relative w-full min-h-screen py-6 px-4 sm:px-6 md:px-12 text-one overflow-x-hidden">
      ...
      <div className="relative z-10">
        ...
        {/* ── Category Filter Tabs (full-width row below search) ── */}
