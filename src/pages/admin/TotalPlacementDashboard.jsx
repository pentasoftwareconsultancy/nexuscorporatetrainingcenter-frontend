        ...
        <div className="flex flex-col gap-4 mt-4">
          {finalResult.map((u, idx) => (
            <div
              ...
              grid grid-cols-1 md:grid-cols-5 gap-2 md:gap-4 items-center justify-start"
            >
              <div className="hidden md:block truncate">
                <img
                  src={u.image}
                  alt={u.student_name}
                  className="w-10 h-10 rounded-full object-cover object-[50%_30%] border"
                />
              </div>
          ...
          {finalResult.length === 0 && (
            <p className="text-center text-gray-400 mt-4">No placements found</p>
          )}
        </div>
      </main>
      <button
